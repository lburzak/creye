...
- The renderer must display hierarchy, dependency edges, changed symbols, related symbols, and unresolved or diagnostic states.
...
2. The renderer MUST consume a graph view model instead of raw git, PSI, or dependency analysis data.
