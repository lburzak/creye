...
## Constraints
1. Graph model construction MUST be independent from the UI renderer (realizing CAMPAIGN constraint 3).
2. The graph model MUST represent hierarchical containment separately from dependency relationships.
3. The graph model MUST represent changed, related (as defined in CORE-USE-CASE.md), unresolved, and structural nodes where needed.
